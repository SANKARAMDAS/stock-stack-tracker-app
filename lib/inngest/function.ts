...
import {
    ...
    PERSONALISED_WELCOME_EMAIL_PROMPT,
...
export const sendSignUpEmail = inngest.createFunction(
    ...
    async ({event, step}) => {
        ...
        await step.run('send-welcome-email', async () => {
            ...
            const introText = (part && 'text' in part ? part.text : null) || 'Thanks for joining StockStack. You now have the tools to track markets and make smarter moves.';
